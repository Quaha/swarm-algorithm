...
python .\plotter.py "..\build\CRS_1.csv" "..\build\SOFA_1.csv" "..\build\MINGO_1.csv" "..\build\DE_1.csv" --title "Bent Cigar func" -o "out\BentCigar_func.jpg"
python .\plotter.py "..\build\CRS_5.csv" "..\build\SOFA_5.csv" "..\build\MINGO_5.csv" "..\build\DE_5.csv" --title "Rastrigin func" -o "out\Rastrigin_func.jpg"
